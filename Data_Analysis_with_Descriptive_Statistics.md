...
ในstatementที่2 คือ การหาค่าเฉลี่ยของช่องtvN โดยใช้filterข้อมูลที่network = tvNเท่านั้น และส่งข้อมูลมาsummarise คำสั่งmean เพื่อหาค่าเฉลี่ยข้อมูลที่ส่งมา เพื่อให้ได้ค่าที่ต้องการ
```
