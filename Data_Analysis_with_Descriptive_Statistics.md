...
## From Top 100 Korean Drama Dataset [(Link)](./top100_kdrama_clean_AirOn_network.csv)
...
### 10) เนื่องจากในปี 2017 และ 2020 มีจำนวนซีรีย์เกาหลีที่ออนแอร์ภายในสองปีนั้น เป็นจำนวนมากที่สุด โดยในปี 2017 มีจำนวน 17 เรื่องและในปี 2020 มีจำนวน 20 เรื่อง
...
Descriptive statistics Statement
```{R}
ใช้คำสั่ง count เพื่อนับจำนวนข้อมูลของซีรีย์เกาหลีที่ออนแอร์ในปีที่เลือก โดยที่เลือกด้วยคำสั่ง filter เงื่อนไขเลือกด้วยปี 2017 และ ปี 2020
```

### 11) จำนวนเรตติ้งเป็นสิ่งที่วัดความนิยมของซีรีย์เกาหลีที่ออนแอร์ออกมา และเนื่องจากใน Top 100 ซีรีย์เกาหลียอดฮิต ในปี 2020 มีจำนวนซีรีย์เกาหลีติด  Top 100 เป็นจำนวนมากที่สุดและค่าเฉลี่ยเรตติ้งของซีรีย์ที่ออนแอร์ในปี 2020 คือ 8.72

```{R}
kdrama  %>% filter(Year.of.release=="2020") %>% summarise(avg = mean(Rating, na.rm = TRUE))
```
Descriptive statistics Statement
```{R}
ใช้คำสั่ง filter เงื่อนไขเพื่อเลือกปี 2020 จากนั้นใช้คำสั่ง summarise หาค่าเฉลี่ยของเรตติ้ง
```
